    ...
    const fetchProjects = async () => {
      try {
        const response = await fetch(
          "https://l2-b2-frontend-path-assignment-6-server-starter-pack-chi.vercel.app/api/v1/blogs"
        );
      ...
      <div>
        ...
        <div>
          {projects.map((project, index) => (
            ...
            >
              <div className="flex-1 gap-4 ">
                <span className="">{project.blogName}</span>
              </div>
              <div className="flex-1">
                <img className="max-w-[100px]" src={project.blogImage} alt="" />
              </div>
              <button
